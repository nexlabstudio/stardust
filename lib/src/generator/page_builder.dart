...
''';
  ...
  String _buildSocialLinks() {
    ...
    if (config.social.github != null) {
      links.add('''
        <a href="${config.social.github}" target="_blank" rel="noopener" class="theme-toggle" aria-label="GitHub">
    ...
    if (config.social.discord != null) {
      links.add('''
        <a href="${config.social.discord}" target="_blank" rel="noopener" class="theme-toggle" aria-label="Discord">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    if (config.social.twitter != null) {
      links.add('''
        <a href="${config.social.twitter}" target="_blank" rel="noopener" class="theme-toggle" aria-label="Twitter">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
