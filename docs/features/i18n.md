...
docs/
  ...
  es/
    index.md        → /es/         (es)
  (no es/guide.md   → /es/guide falls back to docs/guide.md + notice)
```
...
Keep the default locale in `content.dir` and each translated locale in a
subdirectory named after its code:
...
docs/
  ...
  guide.md
  es/
    index.md        # Spanish translations
  ar/
    index.md        # Arabic translations
```
